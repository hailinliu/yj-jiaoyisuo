...
public class PayOrderSellActivity extends BaseActivity<PayOrderSellActivityPresenter> {
    ...
    protected void initEvent() {
        ...
        tv_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               BottomSheetUtil.getBottomSheetShenSu(PayOrderSellActivity.this, "申诉", new BottomSheetUtil.OnInputList() {
                   @Override
                   public void onSure(String... str) {
        ...
        tv_sure.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetUtil.showYanZhengMa1(PayOrderSellActivity.this,"请输入你的交易密码","交易密码", new BottomSheetUtil.NewOnSure() {
                    @Override
