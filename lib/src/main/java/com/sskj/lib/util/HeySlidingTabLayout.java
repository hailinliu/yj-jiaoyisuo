 ...
 *
 */
public class HeySlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public HeySlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public HeySlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeySlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new HeySlidingTabLayout.InnerPagerAdapter(fa.getSupportFragmentManager(), fragments, titles));
