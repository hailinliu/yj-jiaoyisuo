...
public class RxNoLifeFingerPrinter implements LifecycleListener {
    ...
    public RxNoLifeFingerPrinter(@NonNull Activity activity) {
    ...
    public RxNoLifeFingerPrinter begin() {
        dispose();
