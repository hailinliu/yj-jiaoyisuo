...
import com.sskj.bibi.presenter.SlideHangqingFragmentPresenter;
...
@Route(path = RConfig.BIBI_FRAGMENT_SLIDE)//侧滑
public class SlideHangqingFragment extends BaseFragment<SlideHangqingFragmentPresenter> {
    ...
    protected int getLayoutId() {
        return R.layout.bibi_fragment_slide_hangqing;
    }
    ...
    private void initAdapter() {
        slimAdapter = SlimAdapter.create().register(R.layout.bibi_recy_item_slide, new SlimInjector<CoinBean>() {
            @Override
