...
@Route(path = RConfig.LEVELALLENTRUSTFRAGMENT)
public class LevelAllEntrustFragment extends BaseFragment<LevelAllEntrustPresenter> {
    ...
    @Override
    protected LevelAllEntrustPresenter getPresenter() {
        return new LevelAllEntrustPresenter();
    }
    ...
    protected void initView() {
        ...
        slimAdapter = SlimAdapter.create().register(R.layout.level_recy_item_current_entrust, new SlimInjector<HistoryBean.ContentBean>() {
            @Override
